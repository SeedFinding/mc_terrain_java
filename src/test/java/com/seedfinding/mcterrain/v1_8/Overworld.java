package com.seedfinding.mcterrain.v1_8;
...
@DisplayName("Minecraft v1.8 Overworld")
@Tag("v1.8")
@TestFramework.Overworld
public class Overworld {
	public static final MCVersion VERSION = MCVersion.v1_8;
