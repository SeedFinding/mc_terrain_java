package com.seedfinding.mcterrain.v1_13;
...
public class Overworld {
	...
	public void size16() {
		TestFramework.randomChunkGen(VERSION, 1232903292041L, DIMENSION, 16, 21382138983289132L, size16);
	}

	@Test
	@DisplayName("Test Height version 1.13 map size 32")
	public void size32() {
		TestFramework.randomChunkGen(VERSION, 1232903292041L, DIMENSION, 32, 21382138983289132L, size32);
	}

	@Test
	@DisplayName("Test Height version 1.13 map size 128")
	public void size128() {
		TestFramework.randomHashGen(VERSION, 1232903292041L, DIMENSION, 128, 21382138983289132L, 1018152795219244607L);
	}
