...
public class End {
	...
	public void size16() {
		TestFramework.randomChunkGen(VERSION, 123909012342109241L, DIMENSION, 16, 21382138983289132L, size16);
	}

	@Test
	@DisplayName("Test Height version 1.12 map size 32")
	public void size32() {
		TestFramework.randomChunkGen(VERSION, 981293281392132132L, DIMENSION, 32, 21382138983289132L, size32);
	}

	@Test
	@DisplayName("Test Height version 1.12 map size 128")
	public void size128() {
		TestFramework.randomHashGen(VERSION, 929123281392132132L, DIMENSION, 128, 21382138983289132L, 2298905152885145662L);
	}
