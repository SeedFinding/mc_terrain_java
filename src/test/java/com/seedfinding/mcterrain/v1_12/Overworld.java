...
public class Overworld {
	...
	public void size16() {
		TestFramework.randomChunkGen(VERSION, 112120023123L, DIMENSION, 16, 21382138983289132L, size16);
	}

	@Test
	@DisplayName("Test Height version 1.12 map size 32")
	public void size32() {
		TestFramework.randomChunkGen(VERSION, 112120023123L, DIMENSION, 32, 21382138983289132L, size32);
	}

	@Test
	@DisplayName("Test Height version 1.12 map size 128")
	public void size128() {
		TestFramework.randomHashGen(VERSION, 213232132139149124L, DIMENSION, 128, 21382138983289132L, 7969545620266398398L);
	}
