package com.seedfinding.mcterrain.v1_11;
...
public class Overworld {
	...
	public void size16() {
		TestFramework.randomChunkGen(VERSION, 3123285319240812381L, DIMENSION, 16, 21382138983289132L, size16);
	}

	@Test
	@DisplayName("Test Height version 1.11 map size 32")
	public void size32() {
		TestFramework.randomChunkGen(VERSION, 3123285319240812381L, DIMENSION, 32, 21382138983289132L, size32);
	}

	@Test
	@DisplayName("Test Height version 1.11 map size 128")
	public void size128() {
		TestFramework.randomHashGen(VERSION, 3123285319240812381L, DIMENSION, 128, 21382138983289132L, 9111972824862961247L);
	}
