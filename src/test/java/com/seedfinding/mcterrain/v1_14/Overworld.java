package com.seedfinding.mcterrain.v1_14;
...
public class Overworld {
	...
	public void size16() {
		TestFramework.randomChunkGen(VERSION, 32132132131332132L, DIMENSION, 16, 21382138983289132L, size16);
	}

	@Test
	@DisplayName("Test Height version 1.14 map size 32")
	public void size32() {
		TestFramework.randomChunkGen(VERSION, 32132132131332132L, DIMENSION, 32, 21382138983289132L, size32);
	}

	@Test
	@DisplayName("Test Height version 1.14 map size 128")
	public void size128() {
		TestFramework.randomHashGen(VERSION, 909789878979231009L, DIMENSION, 128, 21382138983289132L, 4714728801832852039L);
	}
