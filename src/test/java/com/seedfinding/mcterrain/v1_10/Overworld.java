package com.seedfinding.mcterrain.v1_10;
...
@DisplayName("Minecraft v1.10 Overworld")
@Tag("v1.10")
@TestFramework.Overworld
public class Overworld {
	public static final MCVersion VERSION = MCVersion.v1_10;
